...
<!-- <template>
    <div>
        ...
        <div class="nav-menu">
            ...
            <div class="logo">
                <img id="logo" src="../assets/vuejs.png" alt="logo">
            </div>
        ...
        <div class="nav-content" :class="this.showMobileMenu ? 'open-menu' : 'closed-menu'">
            ...
            <ul class="nav-items">
                ...
                <li class="nav-item">
                    <router-link class="nav-link" @click="showMenu()" to="/portfolio">Portfolio</router-link>
                </li>
                <li class="nav-item">
                    <router-link class="nav-link" @click="showMenu()" to="/contact">Contact</router-link>
                </li>
